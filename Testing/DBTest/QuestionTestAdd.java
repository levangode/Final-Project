...
public class QuestionTestAdd {
	...
	public void Test_QuestionResponse_add() {
		...
		Question z = new QuestionResponse("zzz waht is your name?", QuestionTypes.QuestionResponse,
	...
	public void Test_multpleChoice_add() {
		...
		Question z = new MultipleChoiceQuestion("how much is 5 + 5?", QuestionTypes.MultipleChoiceMultipleAnswer, "", 1,
			 5, 1, answers, 7);
	...
	public void Test_MultipleAnswers_add() {
		...
		Question z = new QuestionWithMultipleAnswers("how much is 5 + 0?", QuestionTypes.MultiAnswer, "",  1, 5,
				false, answers, 7);
	...
	public void Test_fillInTheBlanks_add(){
		...
		Question z = new FillTheBlankQuestion("the prettiest animal is ? others are ? ? ? ?",
				QuestionTypes.FillInTheBlanks, "",  5, answers, 8);
